...
const features = [
  ...
  { icon: Bug, title: 'Smart Debugging', desc: 'Upload buggy code and receive deep analysis, fixes, and optimization tips.' },
  { icon: FolderSearch, title: 'File Analyzer', desc: 'Upload PDFs and code files for comprehensive analysis and insights.' },
  { icon: Brain, title: 'General Intelligence', desc: 'Ask anything — science, history, math, writing, and beyond.' },
];
